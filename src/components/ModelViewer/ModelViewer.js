...
const ModelViewer = ({ item, addToWishlist, removeFromWishlist, wishlist }) => {
  ...
  //Viewerrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr
  let modelViewer1 = {
        ...
        <div className="qr-sec">
          ...
          <>
            <QRCode
              ...
              includeMargin
            />
            <button className="close-qr-btn" onClick={handleToggleQRCode}>
                X
            </button>
          </>
          ) : (
            <button className="ar-view-btn" onClick={() => setShowQRCode(true)}>
              AR 
            </button>
          )}
            {/* <button className="add-icon" onClick={handleAddToWishlist}>
